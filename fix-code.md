...
- Review the new change or feature requested by the user that is NOT in the Implementation Plan, and then designate that to be the Current Software Engineering Task in preparation for (Step 2), (Step 3), (Step 4), (Step 5), (Step 6), (Step 13) and (Step 14)
